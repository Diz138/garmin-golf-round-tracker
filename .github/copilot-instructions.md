# GitHub Copilot Instructions — Garmin Golf Round Tracker

> **Sync note:** `CLAUDE.md` (project root) is the canonical AI instructions file.
> This file contains the same content.
